...
export const PatientConsultationHistory = () => {
  ...
  const fetchConsultationHistory = async () => {
    try {
      const response =
        await apiService.getConsultationHistoryForPatient(patientId);
      ...
      <div className="page-container">
          ...
          <div className="consultation-stats">
            ...
            <div className="stat-card">
              <div className="stat-number">
                {consultations.length > 0
                  ? formatDateTime(consultations[0].consultationDate)
                  : "N/A"}
              </div>
        ...
        {consultations.length === 0 ? (
          <div className="empty-state">
            ...
            <p className="mt-1">
              This could be their first visit or consultations haven't been
              documented.
            </p>
          </div>
        ) : (
                ...
                <div key={date} className="consultation-day-group">
                  ...
                  <div className="consultations-list">
                    {dayConsultations.map((consultation) => (
                      <div
                        key={consultation.id}
                        className="consultation-card detailed"
                      >
                        ...
                        <div className="consultation-actions">
                          <button
                            ...
                            onClick={() => {
                              ...
                              alert(
                                "Use this information to identify patterns in the patient's medical history",
                              );
                            }}
                          >
                            Analyze Patterns
          ...
          <div className="diagnostic-assistance">
            ...
            <div className="insights-grid">
              <div className="insight-card">
                ...
                <p>
                  Look for patterns in subjective notes across multiple
                  consultations
                </p>
              </div>
              <div className="insight-card">
