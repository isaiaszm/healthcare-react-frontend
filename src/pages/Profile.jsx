  ...
  const fetchUserData = async () => {
    try {
      ...
      if (userResponse.data.statusCode === 200) {
        ...
        if (
          userResponse.data.data.roles.some((role) => role.name === "PATIENT")
        ) {
          ...
          <div className="profile-header-main">
            <div className="profile-picture-section">
              <div className="profile-picture-container">
                ...
                <div
                  className={`profile-picture-placeholder ${getProfilePictureUrl() ? "hidden" : ""}`}
                >
              ...
              {uploadError && (
                <div className="alert alert-error mt-1">{uploadError}</div>
              )}
              {uploadSuccess && (
                <div className="alert alert-success mt-1">{uploadSuccess}</div>
              )}
            </div>
            ...
            <div className="profile-section">
              ...
              <div className="info-grid">
                <div className="info-item">
                  ...
                  <div className="info-value">
                    {patientData.firstName || "Not provided"}
                  </div>
                </div>
                <div className="info-item">
                  <label className="info-label">Last Name</label>
                  <div className="info-value">
                    {patientData.lastName || "Not provided"}
                  </div>
                </div>
                <div className="info-item">
                ...
                <div className="info-item">
                  ...
                  <div className="info-value">
                    {patientData.genotype || "Not provided"}
                  </div>
                </div>
          ...
          {!patientData && (
            <div className="profile-section">
              <div className="alert alert-info">
                <p>
                  No patient profile found. Please update your profile to add
                  medical information.
                </p>
              </div>
            </div>
